...
const Contact = () => {
    ...
    return (
        <section className="contact section" id="contact">
            <h2 className="section__title">Deja tu Comnentario</h2>
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            <div className="bx bx-mail-send contact__card-icon">
                                ...
                                <a href="mailto:juliangato87@gmail.com" className="contact__button" target="_blank">enviar correo.
                        ...
                        <div className="contact__card">
                            <div className="bx bxl-whatsapp contact__card-icon">
                                ...
                                <a href="https://walink.co/0079b0" target="_blank"className="contact__button">escribeme.
                                <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="contact__content">
                    ...
                    className="contact__form">
                        ...
                        <div className="contact__form-div contact__form-area">
                            <label className="contact__form-tag">Comentario</label>
                            <textarea 
                            name="project"  
                            cols="30" 
                            rows="10" 
